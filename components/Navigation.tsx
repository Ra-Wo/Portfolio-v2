...
export default function Navigation() {
  ...
  return (
    <div className="fixed z-50 w-full">
      <nav className="overflow-visible w-full pt-1 glass-nav">
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 mt-2 z-30">
          <div className="mx-4 rounded-xl bg-background/90 backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden">
