...
import { socialLinks, contactInfo, heroData } from "@/lib/data";
...
export default function Hero() {
  ...
  const downloadResume = () => {
    ...
    link.href = heroData.buttons.resume.file;
    link.download = heroData.buttons.resume.downloadName;
    link.target = "_blank";
        ...
        <div className="flex flex-col items-center justify-center gap-8 min-h-[80vh]">
          ...
          <div className="text-center space-y-6 flex flex-col items-center justify-center max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button
                size="lg"
                onClick={() => scrollToSection(heroData.buttons.contact.href)}
